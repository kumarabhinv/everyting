...
@CucumberOptions(features = {"src/test/resources/features/sportsBetting/Regression/RT_SB_Live_Betting.feature"},
        monochrome = true,
        glue = {"sportsBetting"},
        tags = {"@MOBILE"},
...
public class
SportsBettingRegressionCukes extends AbstractTestNGCucumberTests {
